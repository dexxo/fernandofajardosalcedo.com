		...
		<main className="font-sans antialiased leading-normal tracking-wider bg-cover">
			<div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
				<div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
					<div className="p-4 md:p-12 text-center lg:text-left">
						<div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
							style={{ backgroundImage: "url('https://gravatar.com/avatar/36f126dcedc1b26a8e530495c320f96c?size=256')" }}></div>

						<h1 className="text-3xl font-bold pt-8 lg:pt-0 capitalize ">fernando fajardo salcedo</h1>
						...
						<p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
							...
							</svg>Software Engineer - FE Architech - <a href="https://www.globant.com/" target="_blank">@Globant</a>
						</p>
						<p className="pt-2 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
							...
							</svg> Medellin - Colombia
						</p>
						<p className="pt-8 text-sm">Hey, I’m Fernando. I’m a software engineer at Globant living in Medellin - Colombia. I am a fan of javascript, nodejs, and technology. I’m also interested in music and coffee. You can hire me with a click on the button above..</p>

						<div className="pt-12 pb-8">
							<a href="https://www.linkedin.com/in/fernando-jose-fajardo-salcedo" className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
								Hire me
							</a>
						</div>
				...
				<div className="w-full lg:w-2/5">
					<img src="https://gravatar.com/avatar/36f126dcedc1b26a8e530495c320f96c?size=256" className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" />
				</div>
			</div>
		</main >
	);
